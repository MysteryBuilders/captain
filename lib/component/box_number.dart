...
class BoxNumberTextField extends StatelessWidget {
  final String hint;
  final IconData icon;
  ...
  BoxNumberTextField({Key key, @required this.hint,@required this.icon,@required this.onClick, this.mText,this.size}) : super(key: key);
